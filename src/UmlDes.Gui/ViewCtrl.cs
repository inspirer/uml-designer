...
namespace CDS {
	...
	public class ViewCtrl : System.Windows.Forms.UserControl, IDisposable {
		...
		private void SetupResources() {
			...
			shared_fonts[(int)FontTypes.ROLE_NAME,0] = new Font( "Tahoma", 8 );
			shared_fonts[(int)FontTypes.DEFAULT,0] = Font;
		...
		protected override void OnDragEnter(DragEventArgs drgevent) {
			if( curr == null )
				return;
			curr.mouseagent.StartDrag( (CSharp.CS_Element)DragObject );
		}
